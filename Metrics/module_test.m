...
%--------------------------------------------------------------------------
    ...
    methods(Access = ?GUI)
        ...
        function obj = module_test(GUI)
            ...
            obj.control.algPopmenu.index = find(strcmp('Proposed_Algorithm',get([obj.control.algPopmenu.items.handle],'String')),1);
            obj.control.proPopmenu.index = find(strcmp('DOC1',get([obj.control.proPopmenu.items.handle],'String')),1);
            ...
            obj.control.metricList = newPopmenu2(panel,[10 455 120 20,0 0 0 1],[.1 .1 .1],false,['IGD';obj.GUI.metList{2,2};obj.GUI.metList{1,2}],'callback',@obj.cb_metricList);
